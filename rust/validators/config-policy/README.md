...
**ABI:** The crate exports `wasm_alloc`, `wasm_dealloc`, `validate`, `error_ptr`, and `error_len`. See the Go repo's [docs/wasm-validation-abi.md](../../../docs/wasm-validation-abi.md) for the contract.
